...
Gneiss.defaultGneissChartConfig = {
	...
	colors: ["#e8e4df", "#d41124", "#cccccc", "#d5dcdc", "#98bdc8", "#6e6e6e", "#abc057", "#006633", "#74b8bd", "#336699", "#b64178", "#660000", "#ff4cf4","#ffb3ff","#e69ce6","#cc87cc","#b373b3","#995f99","#804c80","#665266","#158eff","#99cdff","#9cc2e6","#87abcc","#7394b3","#5f7d99","#466780","#525c66"], //this is the order of colors that the
	padding :{
		top: 25,
		bottom: 50,
		left: 10,
